...
<div class="page-banner">
  ...
  <div class="metabox metabox--position-up metabox--with-home-link">
    ...
    $relatedProfessors = new WP_Query(array(
      ...
      'meta_query' => array (
        array(
          ...
          'compare'=> 'LIKE',
          //We wrap this in quotes because wordpress puts the id as a string
          'value'=> '"' . get_the_ID() . '"'
        )
      )
    ));
    ...
    <?php 
    //Custom query to get related events
    $today = date('Ymd');
...
,              ),
  ...
  ?></span>
        ...
        <div class="event-summary__content">
          ...
          ?>  <a href="<?php the_permalink();?>" class="nu gray"><br />Learn more</a></p>
        </div>
      </div>
      <?php endwhile; ?>
        <?php endif; ?>
